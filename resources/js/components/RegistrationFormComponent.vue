<template>
    <div>
        <br/><br/>
        <error-alert v-if="show" message="Registration Failed" :error="err_msg"> </error-alert>
        <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="validate_form" method="post">
                                ...
                                <button v-on:click="go_to_login" class="btn btn-primary" style="float: right;">Login</button>
                            </form>
                        </div>
                    </div>
                </div>
